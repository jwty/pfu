...
cursor.execute('CREATE TABLE IF NOT EXISTS files (id INTEGER PRIMARY KEY, original_filename TEXT, new_filename TEXT, upload_date INTEGER, keep INTEGER, checksum TEXT UNIQUE)')
